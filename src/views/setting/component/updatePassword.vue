<template>
  <div id="password">
    <el-form ref="form" style="margin:15px;" :rules="rules" :label-position="labelPosition" label-width="80px" :model="formLabelAlign">
      <el-form-item label="请输入旧提现密码" prop="password" style="width: 20vw;">
        <el-input v-model="formLabelAlign.password" type="password" />
      </el-form-item>
      <el-form-item label="请输入新提现密码" prop="pay_pwd">
        <el-input v-model="formLabelAlign.pay_pwd" style="width: 20vw;" type="password" />
      </el-form-item>
      <el-form-item label="请确认新提现密码" prop="confirm_pay_pwd">
...
<script>
import { updatePayPassword } from '@/api/tsyaccount'
export default {
  name: 'Password',
  data() {
    return {
