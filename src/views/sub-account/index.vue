  ...
  <div id="sub-account">
    <div id="searchBox">
      <div v-show="showQuery">
        ...
        <el-select size="mini" v-model="query.bank_code" filterable clearable placeholder="请选择">
          <el-option
        ...
        <span style="margin-right:15px;margin-left:30px;">银行卡号:</span><el-input size="mini" v-model="query.account_no" placeholder="银行卡号" style="width: 11vw;margin-right:15px" class="filter-item" />
        <span style="margin-right:15px">持卡人姓名:</span><el-input size="mini" v-model="query.account_name" placeholder="持卡人姓名" style="width: 6vw;margin-right:15px;" class="filter-item" />
        <span style="margin-right:15px">持卡人电话:</span><el-input size="mini" v-model="query.tel" placeholder="持卡人电话" style="width: 8vw;" class="filter-item" />
        </p>
        ...
        <el-select size="mini" style="width:6vw"v-model="query.state" filterable clearable placeholder="请选择">
          <el-option
        ...
        <el-tooltip  style="margin-left:30px;" class="item" effect="dark" content="收起" placement="right">
          <i class="el-icon-arrow-up" @click="showQuery=false"></i>
        </el-tooltip>
      </div>
