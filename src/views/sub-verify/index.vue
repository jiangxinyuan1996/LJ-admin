  ...
  <div id="sub-verify">
    <div id="searchBox">
      <div id="buttonBox" style="margin:50px;">
        ...
        <span class="demonstration">分账方 : </span>
        <el-select size="mini" v-model="subuser1" filterable placeholder="请选择">
          <el-option
        ...
        <span class="demonstration">被分账方 : </span>
        <el-select size="mini" v-model="subuser2" filterable placeholder="请选择">
          <el-option
      ...
      >
        ...
        <el-table-column label="操作"  width="120"align="center">
          ...
          <template slot-scope="scope">
            <el-tooltip class="item" effect="dark" content="提交" placement="left">
            ...
            <el-tooltip class="item" effect="dark" content="查看明细" placement="right">
              <el-button type="primary" icon="el-icon-search" size="mini" circle @click="commit(scope.row)" />
            </el-tooltip>
        ...
        tableData: [
          {
            ...
            account:"2000000",
            subuser1:"朗杰",
            subuser1Account:"1000000000",
            subuser2:"被分账方1",
            subuser2Account:"5000000",
            detailNum:"2"
          },
          {
            id:"A100000002",
            ...
            account:"50000",
            subuser1:"朗杰",
            subuser1Account:"700000",
            subuser2:"被分账方3",
            subuser2Account:"30000",
            detailNum:"3"
          },
        ],
        currentPage: 1,
